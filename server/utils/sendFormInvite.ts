  ...
  return `
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px; text-align: center;">
            <div style="background-color: #fff; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);">
                ...
                <h1 style="color: #6d63fc;">You're Invited to Take an Assessment!</h1>
                <p>Hello, ${email} </p>
                <p>Your Recruiter liked your profile.</p>
                <p>${message}</p>
                <a href=${url} style="display: inline-block; padding: 10px 20px; background-color: #6d63fc; color: #fff; text-decoration: none; border-radius: 5px; transition: background-color 0.3s;">Take Assessment</a>
